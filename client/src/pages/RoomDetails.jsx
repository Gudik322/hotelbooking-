  ...
  const checkAvailability = async ()=>{
    try {
      ...
      if(checkInDate >= checkOutDate){
        toast.error("Check-In Date should be less")
        return;
      }
    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap items-center mt-3 mb-6 gap-4">
              {room.amenities.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center gap-2 px-3 py-3 rounded-lg bg-gray-100"
                >
                  <img
        ...
        <form onSubmit={onSubmitHandler} className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
          ...
          <button
            type="submit"
            className="bg-primary hover:bg-primary-dull actve:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer"
          >
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <div className="flex items-center mt-1">
                <StarRating />
                <p className="ml-2">322+ reviews</p>
              </div>
            </div>
          </div>
