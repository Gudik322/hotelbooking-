        ...
        <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
          ...
          <div className="w-full mt-4">
            ...
            <input
              ...
              className="border broder-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light"
              required
            />
          </div>
          {/* Phone */}
          ...
          <div className="w-full mt-4 max-w-60 mr-auto">
            ...
            <select onChange={(e)=> setCity(e.target.value)}
              value={city}
            id="city" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required>
